...
/** @type {string} */
const CACHE_VERSION = '1789321028|2805714';
/** @type {string} */
...
if (isNavigate && new URL(event.request.url).pathname === new URL(self.registration.scope).pathname) { cached = await cache.match("index.html"); }
				if (cached != null) {
					if (ENSURE_CROSSORIGIN_ISOLATION_HEADERS) {
